...
{
	public class ProfileExperienceCollectablesSpawnSystem : IEcsInitSystem, IEcsRunSystem
	{
		private const float SPAWN_RATE = 60f;
		...
		public ProfileExperienceCollectablesSpawnSystem(ICollectableEntityFactory collectableEntityFactory)
		{
		...
		public void Init(EcsSystems systems)
		{
			...
			_collectableConfigs = sharedData.CollectablesConfigProvider.AllCollectables.Where(_ => _.Type == CollectableType.ProfileExperience).ToArray();
		}
