...
{
	public class MagnetCollectablesSpawnSystem : IEcsInitSystem, IEcsRunSystem
	{
		...
		public MagnetCollectablesSpawnSystem(ICollectableEntityFactory collectableEntityFactory)
		{
		...
		public void Init(EcsSystems systems)
		{
			...
			_collectableConfigs = sharedData.CollectablesConfigProvider.AllCollectables.Where(_ => _.Type == CollectableType.Magnet).ToArray();
		}
