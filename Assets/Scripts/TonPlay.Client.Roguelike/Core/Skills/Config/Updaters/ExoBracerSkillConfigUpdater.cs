...
{
	public struct ExoBracerSkillConfigUpdater : IUpdatable
	{
		private readonly ExoBracerSkillConfig _config;
		private readonly BoostAllResponse.Boost _remoteConfig;
		
		public ExoBracerSkillConfigUpdater(
			ExoBracerSkillConfig config, 
