...
{
	public struct HolyWaterSkillConfigUpdater : IUpdatable
	{
		private readonly HolyWaterSkillConfig _config;
		private readonly SkillAllResponse.Skill _remoteConfig;
		
		public HolyWaterSkillConfigUpdater(
			HolyWaterSkillConfig config, 
