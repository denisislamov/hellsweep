...
{
	public struct HiPowerMagnetSkillConfigUpdater : IUpdatable
	{
		private readonly HiPowerMagnetSkillConfig _config;
		private readonly BoostAllResponse.Boost _remoteConfig;
		
		public HiPowerMagnetSkillConfigUpdater(
			HiPowerMagnetSkillConfig config, 
