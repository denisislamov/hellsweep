...
namespace TonPlay.Client.Roguelike.Core.Skills.Config
{
	...
	public class HiPowerBulletSkillConfig : SkillConfig<IHiPowerBulletSkillLevelConfig>, IHiPowerBulletSkillConfig
	{
		...
		public override IHiPowerBulletSkillLevelConfig GetLevelConfig(int level) => GetLevelConfigInternal(level);
		...
		[Serializable]
		public class LevelConfig : IHiPowerBulletSkillLevelConfig
		{
			[SerializeField]
			private int _level;
